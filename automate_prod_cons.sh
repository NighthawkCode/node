...
if [ ! -f ${HOME}/verdant/dev/build/third_party/vstack/node/test/cons ]; then
...
${HOME}/verdant/dev/build/third_party/vstack/node/test/cons -m 350 &> ${HOME}/verdant/dev/third_party/vstack/node/test/cons_log.txt & CONS_APP=$!
